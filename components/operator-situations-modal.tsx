...
import { Search, AlertCircle, ZoomIn, ZoomOut, ChevronDown, ChevronUp, Loader2 } from "lucide-react"
...
export const OperatorSituationsModal = memo(function OperatorSituationsModal({
  ...
  const { situations: situationsRaw, loading } = useCachedSituations()
  ...
  const toggleExpand = useCallback((situationId: string) => {
    setExpandedCards((prev) => ({
      ...prev,
      [situationId]: !prev[situationId],
    }))
  }, [])
          ...
          <div className="p-6 space-y-3">
            {loading ? (
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <p className="text-muted-foreground">Carregando situacoes...</p>
              </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 overflow-hidden">
                          ...
                          {situation.description ? (
                            <>
                              <p
                                className={`text-muted-foreground leading-relaxed break-words transition-all ${!isExpanded && shouldTruncate ? "line-clamp-2" : ""}`}
